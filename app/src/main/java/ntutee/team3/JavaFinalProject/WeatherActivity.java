    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        findViewById(R.id.change_city).setOnClickListener(view ->
        {
            ...
            builder.setItems(city_options, (dialog, which) ->
            {
                ...
                Toast.makeText(WeatherActivity.this, "你選擇了：" + city_options[which], Toast.LENGTH_SHORT).show();
            });
            builder.create().show();
        });
        ...
        findViewById(R.id.get_weather).setOnClickListener(v ->
        {
            ...
            runOnUiThread(() ->
            {
                if (selectedCity_index == -1)
                    Toast.makeText(WeatherActivity.this, "請先選擇一個縣市", Toast.LENGTH_SHORT).show();
                else if(selectedTime_index == -1)
                    Toast.makeText(WeatherActivity.this, "請先選擇一個時段", Toast.LENGTH_SHORT).show();
                else
                {
